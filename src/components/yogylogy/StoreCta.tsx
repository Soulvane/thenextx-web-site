...
/** 기기 감지 스토어 버튼. Android=Play, iOS=TestFlight. 문구는 dictionary. */
export default function StoreCta({ lang = "ko" }: { lang?: Lang }) {
  ...
  return (
    <div className="flex flex-col gap-2.5 sm:gap-3">
      ...
      >
        ...
        <span className="whitespace-nowrap">{t.play}</span>
      ...
      >
        ...
        <span className="whitespace-nowrap">{t.ios}</span>
        <span className="shrink-0 rounded-md bg-white/20 px-1.5 py-0.5 text-[11px] font-medium">
          {t.iosBadge}
        </span>
      </a>
