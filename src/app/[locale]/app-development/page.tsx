...
export async function generateMetadata({
  ...
  return pageMetadata(locale, "/app-development", {
    en: {
      title: "Flutter App Development — iOS & Android",
      description:
        "Cross-platform Flutter apps shipped to iOS and Android from a single codebase — fast, beautiful, and production-ready.",
    },
    ko: {
      title: "플러터 앱 개발 — iOS & Android",
      description:
        "하나의 Flutter 코드베이스로 iOS·Android에 동시 배포하는 크로스플랫폼 앱. 빠르고 완성도 높은 프로덕션 앱을 만듭니다.",
    },
  });
}
