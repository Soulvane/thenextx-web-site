...
export async function generateMetadata({
  ...
  return pageMetadata(locale, "/team", {
    en: {
      title: "Team — Korean-Native Bilingual Development, Design & Marketing",
      description:
        "TheNextX is a Korean-native, bilingual (KO/EN) team of developers, designers, and marketers combining deep expertise with AI-powered delivery.",
    },
    ko: {
      title: "팀 — 한국어 네이티브 개발·디자인·마케팅",
      description:
        "한국어 네이티브 · 한/영 이중언어로 일하는 개발·디자인·마케팅 팀. 깊은 전문성과 AI 기반 실행을 결합해 빠르고 정밀하게 만듭니다.",
    },
  });
}
