...
export async function generateMetadata({
  ...
  return pageMetadata(locale, "/mailing", {
    en: {
      title: "Direct Mail & Offline Marketing Operations",
      description:
        "End-to-end offline direct mail — postcards, catalogs, and print campaigns fully managed from strategy to delivery.",
    },
    ko: {
      title: "다이렉트 메일 & 오프라인 마케팅 운영",
      description:
        "엽서, 카탈로그, 인쇄 캠페인까지 — 전략부터 디자인, 인쇄 제작, 배송, ROI 측정까지 관리하는 오프라인 다이렉트 메일 운영.",
    },
  });
}
